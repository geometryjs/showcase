...
Je automaticky generována systémem TypeDoc\footnote{Spouštění generování je zajištno přes GitHub Action, která aktivuje \uv{rebuild} stránky na Cloudflare Pages\cite{geometryjs:wiki:api}.}\cite{geometryjs:wiki:technologies} a je dostupná na adrese \url{https://geometryjs.jiricekcz.dev/api/}.
