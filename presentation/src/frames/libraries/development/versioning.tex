...
\begin{frame}
    ...
    \only<1>{
        \begin{figure}
            \centering
            \includegraphics[height=0.7\textheight]{../resources/github-page.png}
    ...
    \only<2>{
        \begin{figure}
            \centering
            \includegraphics[height=0.65\textheight]{../resources/github-issues.png}
    ...
    \only<3>{
        \begin{figure}
            \centering
            \includegraphics[height=0.7\textheight]{../resources/github-commits.png}
